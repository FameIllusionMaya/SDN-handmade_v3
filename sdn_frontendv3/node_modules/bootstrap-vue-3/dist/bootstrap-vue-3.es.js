...
const Element$1 = HAS_WINDOW_SUPPORT ? WINDOW.Element : class Element2 extends Object {
};
const HTMLElement$1 = HAS_WINDOW_SUPPORT ? WINDOW.HTMLElement : class HTMLElement2 extends Element$1 {
};
HAS_WINDOW_SUPPORT ? WINDOW.SVGElement : class SVGElement2 extends Element$1 {
};
...
const isElement$1 = (el) => !!(el && el.nodeType === Node.ELEMENT_NODE);
const getBCR = (el) => isElement$1(el) ? el.getBoundingClientRect() : null;
const getActiveElement = (excludes = []) => {
  const { activeElement } = document;
  return activeElement && !excludes.some((el) => el === activeElement) ? activeElement : null;
};
const isActiveElement = (el) => isElement$1(el) && el === getActiveElement();
...
const getStyle = (el, prop) => prop && isElement$1(el) ? el.getAttribute(prop) || null : null;
const isVisible = (el) => {
...
const isEmptySlot = (slot, data2) => !slot || slot(data2).filter((vnode) => vnode.type !== Comment).length < 1;
const select = (selector, root) => (isElement$1(root) ? root : DOCUMENT).querySelector(selector) || null;
const selectAll = (selector, root) => from((isElement$1(root) ? root : DOCUMENT).querySelectorAll(selector));
const getAttr = (el, attr) => attr && isElement$1(el) ? el.getAttribute(attr) : null;
const setAttr = (el, attr, value) => {
  if (attr && isElement$1(el)) {
  ...
  setup(props, { emit, attrs }) {
    ...
    const computedHref = computed(() => {
      ...
      if (Object.prototype.toString.call(to) === "[object Object]" && (to.path || to.query || to.hash)) {
        ...
        const hash2 = !to.hash || to.hash.charAt(0) === "#" ? to.hash || "" : `#${to.hash}`;
        return `${path}${query}${hash2}` || toFallback;
      }
      return toFallback;
    });
    const focus2 = () => {
  ...
  (function(global2, factory) {
    ...
    class Carousel2 extends BaseComponent__default.default {
      ...
      static carouselInterface(element, config) {
        const data2 = Carousel2.getOrCreateInstance(element, config);
        let {
          _config
        } = data2;
...
const _sfc_main$Y = defineComponent({
  ...
  setup(props, { emit }) {
    ...
    onMounted(() => {
      var _a;
      instance.value = new Dropdown((_a = dropdown2.value) == null ? void 0 : _a.$el, {
...
(function(module, exports) {
  (function(global2, factory) {
    module.exports = factory(tooltip.exports);
  })(commonjsGlobal, function(Tooltip2) {
    const _interopDefaultLegacy = (e) => e && typeof e === "object" && "default" in e ? e : { default: e };
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.tabs, ({ tab, buttonId, contentId, navItemClasses, active, target }, idx) => {
            return openBlock(), createElementBlock("li", {
              ...
              createElementVNode("a", mergeProps({
                ...
                onClick: withModifiers((e) => _ctx.handleClick(e, idx), ["stop"])
              }), [
